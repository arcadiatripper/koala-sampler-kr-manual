...
* **Export bit depth:** 내보내는 WAV 파일의 비트 깊이를 16비트 또는 24비트로 정합니다.
* **Koala version:** 현재 앱 버전과 활성화된 인앱 구매 정보를 보여 줍니다.
* **Stem splitter neural network:** `UNINSTALL`을 누르면 `SPLIT STEMS`에 필요한 모델 파일을 제거합니다.
