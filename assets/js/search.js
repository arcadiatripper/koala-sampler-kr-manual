...
{% if url contains 'chapters' %}
    ...
    {% endcomment %}
    {% assign url = parts[1] | prepend: '/' | append: '/' | append: chapter_name | append: '/#' | append: chapter_number | append: screen_name %}
{% endif %}

{% assign url = url | prepend: '/koala-sampler-kr-manual' %}
